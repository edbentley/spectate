...
import { TextVar, Variable, VariableComparitor, VariableList } from "./variables";

export type SpecBase = Record<string, SpecField>;

export type SpecField = Variable | Component | Effect | VariableList<Variable> | ComponentList<Component, Variable>;
